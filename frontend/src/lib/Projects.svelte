...
<div class="grid gap-5 xl:grid-cols-[minmax(0,2fr)_minmax(18rem,1fr)]">
	<section
		class="list-panel mt-0 card border border-surface-300-700 bg-surface-50-950 p-5 shadow-sm"
	>
		...
		{:else}{#each projects.data ?? [] as project (project.id)}
				<a
					class="item-row group rounded-lg px-2 hover:bg-surface-200-800"
	...
	<aside class="list-panel mt-0 card border border-surface-300-700 bg-surface-50-950 p-5 shadow-sm">
